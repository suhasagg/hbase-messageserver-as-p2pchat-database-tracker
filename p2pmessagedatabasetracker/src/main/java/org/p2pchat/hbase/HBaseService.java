...
public class HBaseService {
	...
	public List<Result> getRowsBetween(String tableName, String columnFamily, String startRowKey, String endRowKey)
			throws IOException {
		Table table = connection.getTable(TableName.valueOf(tableName));
	...
	public void checkAndPut(String tableName, String rowKey, String columnFamily, String qualifier,
			CompareFilter.CompareOp compareOp, byte[] value) throws IOException {
		Table table = connection.getTable(TableName.valueOf(tableName));
