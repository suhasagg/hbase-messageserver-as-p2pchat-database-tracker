...
FILE=$(wget "https://archive.apache.org/dist/hbase/stable" -O - | grep -Po "hbase-[0-9].[0-9].[0-9][0-9]-bin.tar.gz" | head -n 1)
URL=https://archive.apache.org/dist/hbase/stable/$FILE
